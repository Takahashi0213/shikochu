...
private:
	...
	//移動関連
	const float followRange = 600.0f; //追尾する距離（追尾を諦めるまでの距離）
	const float attackRange = 180.0f; //攻撃する距離
	...
	const float randomSpeed = 40.0f; //ランダム移動速度

									 //攻撃関連
	int timer = 0; //攻撃のタイマー
	const int yobiwait = 40; //予備動作の時間
	const int attackwait = 20; //攻撃動作の時間
	const float attackMoveRange = 40.0f; //攻撃時の前進距離と速度
