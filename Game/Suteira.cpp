...
bool Suteira::Start() {
	m_animClips[enAnimationClip_move].Load(L"animData/Sute_Run.tka");
	m_animClips[enAnimationClip_move].SetLoopFlag(true);

	m_skinModelRender = NewGO<prefab::CSkinModelRender>(0);
	m_skinModelRender->Init(L"modelData/Suteira.cmo", m_animClips, enAnimationClip_Num);
