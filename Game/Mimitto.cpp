...
bool Mimitto::Start() {
	m_animClips[enAnimationClip_move].Load(L"animData/Mimitto.tka");
	m_animClips[enAnimationClip_move].SetLoopFlag(true);

	m_skinModelRender = NewGO<prefab::CSkinModelRender>(0);
	m_skinModelRender->Init(L"modelData/Mimitto.cmo", m_animClips, enAnimationClip_Num);
